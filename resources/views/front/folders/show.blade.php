					...
					<div class="card">
						<div class="card-header d-flex justify-content-between">
							<span>
							  ...
							  <a href="{{ route('folder.delete',[$folder->id]) }}" class="badge badge-danger ml-1" onclick="return confirm('{{ __('Are you sure that you want to delete this folder') }}?')"><i class="fa fa-trash"></i> {{ __('Delete') }}</a>
							</span>
							<span>
							  <form action="">
							...
							@forelse($pastes as $paste)
								<li class="list-group-item">
									...
									<div class="pull-right">
										...
										<a href="{{url('paste/'.$paste->slug.'/delete')}}" class="badge badge-danger" onclick="return confirm('{{ __('Are you sure that you want to delete this paste') }}?')"><i class="fa fa-trash"></i> {{ __('Delete')}}
										</a>
									</div>
								</li>
							@empty
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body text-center"> @if(config('settings.qr_code_share') == 1)
							<div class="mb-2">
								<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{urlencode($folder->url)}}">
							</div>
						@endif
