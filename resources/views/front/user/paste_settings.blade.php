								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="title" class="form-control mb-4" value="{{old('title',$paste->title)}}" placeholder="{{ __('Untitled')}}" tabindex="1" autofocus autocomplete="off">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>{{ __('Default Password')}} :
												<small class="text-muted">[{{ __('Optional')}}] </small> </label>
											<input type="text" name="password" class="form-control" placeholder="{{ __('Default Password')}}" tabindex="5" value="{{$paste->password}}" autocomplete="off">
										</div>										
									</div>																					
