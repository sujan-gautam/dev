          ...
          <div class="card-body">
            <form method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="code" placeholder="in" value="{{old('code',$language->code)}}">
              </div>            

              <div class="form-group">
                <label>Country Code (ISO 3166-1)</label>
                <input type="text" class="form-control" name="country_code" placeholder="in" value="{{old('country_code',$language->country_code)}}">
              </div>
