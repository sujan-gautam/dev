            ...
            <form method="post">
              ...
              <div class="row">
                  <div class="form-group  col-md-6">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" id="popular1" name="popular" value="1" @if(old('popular',$syntax->popular) == 1) checked @endif>
                      <label class="custom-control-label" for="popular1">Yes </label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" id="popular2" name="popular" value="0" @if(old('popular',$syntax->popular) == 0) checked @endif>
                  ...
                  <div class="form-group  col-md-6">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" id="active1" name="active" value="1" @if(old('active',$syntax->active) == 1) checked @endif>
                      <label class="custom-control-label" for="active1">Yes </label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" id="active2" name="active" value="0" @if(old('active',$syntax->active) == 0) checked @endif>
              ...
              <div class="row">
                  <div class="form-group  col-md-6">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" id="active_link1" name="active_link" value="1" @if(old('active_link',$syntax->active_link) == 1) checked @endif>
                      <label class="custom-control-label" for="active_link1">Yes </label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" id="active_link2" name="active_link" value="0" @if(old('active_link',$syntax->active_link) == 0) checked @endif>
                  ...
                  <div class="form-group  col-md-6">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" id="redirect_page1" name="redirect_page" value="1" @if(old('redirect_page',$syntax->redirect_page) == 1) checked @endif>
                      <label class="custom-control-label" for="redirect_page1">Yes </label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" id="redirect_page2" name="redirect_page" value="0" @if(old('redirect_page',$syntax->redirect_page) == 0) checked @endif>
