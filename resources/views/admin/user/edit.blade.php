								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="tg" placeholder="#" value="{{old('tg',$user->tg)}}">
										</div>
									</div>									
									<div class="col-md-6">
										<div class="form-group">
											<label>Discord Link*</label>
											<input type="text" class="form-control" name="disc" placeholder="#" value="{{old('disc',$user->disc)}}">
										</div>
									</div>									
								</div>
								<div class="row">
